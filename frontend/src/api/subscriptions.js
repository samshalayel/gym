...
export const getSubscriptionPayments = (id) => api.get(`/subscriptions/${id}/payments`)
export const collectSubscriptionPayment = (id, data) => api.post(`/subscriptions/${id}/collect-payment`, data)
...
export const getOverpayments = () => api.get('/subscriptions/overpayments')
export const collectPayment = (id, data) => api.post(`/subscriptions/${id}/collect-payment`, data)
export const getExportDetails = (params) => api.get('/subscriptions/export-details', { params })
export const freezeSubscription = (id, freeze) => api.post(`/subscriptions/${id}/freeze`, { freeze })
